...
func test_integration_expedition_and_network_test_1():
	"""
	Test Integration between Expedition and Network Subsystems on getting expedition list
	"""
	yield(self, 'login_success')
	Network_Services.token = _token
...
func test_integration_expedition_and_network_test_2():
	"""
	Test Integration between Expedition and Network Subsystems on getting data of specific expedition
	"""
	yield(self, 'login_success')
	Network_Services.token = _token
...
func test_integration_world_and_network():
	"""
	Test Integration between World and Network Subsystems
	"""
	yield(self, 'login_success')
	Network_Services.token = _token
...
func test_integration_common_and_battle():
	"""
	Test Integration between Common and Battle Subsystems
	"""
	yield(self, 'login_success')
	Network_Services.token = _token
	...
	assert_not_null(Common_Services.get_user_stats(), 
		"Check integration between Common_Services and Network_Services")

	Battle_Manager.test_init_battle()

	assert_ne(Battle_Manager.get_self_stats(), {},
		"Check integration between Common_Services and Battle_Manager")
